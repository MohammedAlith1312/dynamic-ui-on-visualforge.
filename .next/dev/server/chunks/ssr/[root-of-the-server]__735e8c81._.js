...
"[project]/src/views/Auth.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            if (isLogin) {
                ...
                try {
                    ...
                    if (remoteData.Status === true && remoteData.authData?.authToken) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$schema$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setAuthToken"])(remoteData.authData.authToken);
                        console.log("Remote login successful, token updated.");
                    } else {
                        console.error("Remote login failed", remoteData);
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Connected to local auth, but remote service login failed.");
                    }
                } catch (remoteError) {
                ...
                if (error) throw error;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Account created! You can now log in.");
                setIsLogin(true);
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__735e8c81._.js.map
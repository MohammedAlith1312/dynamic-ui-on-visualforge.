...
"[project]/src/components/datasource/adapters/EntityAdapter.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const fetchEntityData = async (entityId)=>{
    ...
    const entityData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$schema$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEntity"])(entityId);
    const fieldsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$schema$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFields"])(entityId);
    if (!entityData) {
        throw new Error(`Failed to load entity: Entity not found in schema`);
    }
    // Load actual records from Supabase
    const { data: recordsRes, error: recordsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("entity_records").select("*").eq("entity_id", entityId).eq("is_published", true).order("created_at", {
        ascending: false
    });
    if (recordsError) {
...
"[project]/src/components/datasource/adapters/QueryAdapter.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function inferFieldType(value) {
    if (value === null || value === undefined) return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].String;
    if (typeof value === 'boolean') return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].Boolean;
    if (typeof value === 'number') {
        return Number.isInteger(value) ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].Interger : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].Decimal;
    }
    if (typeof value === 'string') {
        // Check if it's a date
        if (/^\d{4}-\d{2}-\d{2}/.test(value) || !isNaN(Date.parse(value))) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].Date;
        }
        // Check if it's a URL
        if (/^https?:\/\//.test(value)) {
            // Check if it's an image URL
            if (/\.(jpg|jpeg|png|gif|webp|svg)$/i.test(value)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].Image;
            }
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].String;
        }
        // Check if it's long text
        if (value.length > 100) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].TextArea;
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].String;
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].String;
...
"[project]/src/components/datasource/adapters/ApiAdapter.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const fetchApiData = async (requestId)=>{
    ...
    const { data, error: funcError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].functions.invoke('execute-api-request', {
        body: {
            requestId
        }
    });
...
function inferFieldType(value) {
    ...
    if (typeof value === 'string') {
        ...
        if (/^https?:\/\//.test(value)) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].String; // No specific URL type in enum, fallback to String or check if you want HTMLEditor
        }
        // Check if it's long text
        if (value.length > 100) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].TextArea;
...
"[project]/src/components/datasource/DatasourceViewOptions.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$CardLayoutEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/entities/CardLayoutEditor.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/entities/FieldEditor.tsx [app-client] (ecmascript)");
;
;
;
...
;
;
const DatasourceViewOptions = ({ fields, viewType, viewOptions, onViewOptionsChange })=>{
    const handleColumnToggle = (fieldId, checked)=>{
        const newVisibleColumns = checked ? [
            ...viewOptions.visibleColumns,
            fieldId
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tabs"], {
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsTrigger"], {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$table$2d$2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Table2$3e$__["Table2"], {
                                    ...
                                    fileName: "[project]/src/components/datasource/DatasourceViewOptions.tsx",
                                    lineNumber: 117,
                                    columnNumber: 58
                                ...
                                children: fields.map((field)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$checkbox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Checkbox"], {
                                                ...
                                                onCheckedChange: (checked)=>handleColumnToggle(field.name, checked)
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/datasource/DatasourceViewOptions.tsx",
                                                lineNumber: 135,
                                                columnNumber: 19
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                    value: "card",
                    className: "space-y-6 mt-0",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$CardLayoutEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardLayoutEditor"], {
                        fields: entityFields,
                        layout: viewOptions.cardLayout || {
                    ...
                    children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                    ...
                                    onValueChange: (value)=>onViewOptionsChange({
                                            ...
                                            kanbanConfig: {
                                                groupByField: value,
                                                cardLayout: viewOptions.kanbanConfig?.cardLayout || {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                            children: [
                                                ...
                                                fields.filter((f)=>f.field_type === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].String).map((field)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                        value: field.name,
                                                        children: field.display_name
                                                    }, field.name, false, {
                                                        fileName: "[project]/src/components/datasource/DatasourceViewOptions.tsx",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$CardLayoutEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardLayoutEditor"], {
                                    fields: entityFields,
                                    layout: viewOptions.kanbanConfig?.cardLayout || {
                                        titleField: fields[0]?.id || '',
                                        displayFields: []
                                    },
                                    onChange: (layout)=>onViewOptionsChange({
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                            children: [
                                                ...
                                                fields.filter((f)=>f.field_type === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].Image).map((field)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                        value: field.name,
                                                        children: field.display_name
                                                    }, field.name, false, {
                                                        fileName: "[project]/src/components/datasource/DatasourceViewOptions.tsx",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                            children: [
                                                ...
                                                fields.filter((f)=>f.field_type === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$entities$2f$FieldEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E_FieldDataType"].Date).map((field)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                        value: field.name,
                                                        children: field.display_name
                                                    }, field.name, false, {
                                                        fileName: "[project]/src/components/datasource/DatasourceViewOptions.tsx",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                    value: viewOptions.sortField || "none",
                                ...
                                viewOptions.sortField && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    variant: "outline",
                                    size: "sm",
...
_c = DatasourceViewOptions;
var _c;
__turbopack_context__.k.register(_c, "DatasourceViewOptions");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_components_datasource_1881633b._.js.map